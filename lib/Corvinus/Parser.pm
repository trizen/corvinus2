        ...
        my %options = (
            ...
            static_obj_re => qr{\G
                (?>
                     ...
                     | (?:Folder|Dosar|Dir)\b                          (?{ state $x = Corvinus::Types::Glob::Dir->new })
                     | (?:File|Fisier)\b                         (?{ state $x = Corvinus::Types::Glob::File->new })
                     | (?:Array|Lista)\b                  (?{ state $x = Corvinus::Types::Array::Array->new })
                     | (?:Multi(?:Lista|Array))\b             (?{ state $x = Corvinus::Types::Array::MultiArray->new })
